...
import BlogSidebarHome from "./pages/blog/BlogSidebarHome";
...
import PortfolioBoxedSpaceTwoHome from "./pages/portfolio/PortfolioBoxedSpaceTwoHome";
      ...
      <ScrollToTop>
        <Switch>
          ...
          <Route
            ...
            component={PortfolioBoxedSpaceTwoHome}
          />
          <Route
            exact
